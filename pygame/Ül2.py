...
bg = pygame.image.load('Ül2 pildid/bg_shop.jpg')  # Lisab tagatusta pildi
screen.blit(bg, [0, 0])  # Muudab pildi asukohta ekraanil

# Blokk lisab müüa, muudab selle asukohta ja suurust
seller = pygame.image.load('Ül2 pildid/seller.png')
...
chat = pygame.image.load('Ül2 pildid/chat.png')
...
vikklogo = pygame.image.load('Ül2 pildid/vikklogo.png')
...
cake = pygame.image.load('Ül2 pildid/cake.png')
...
mook = pygame.image.load('Ül2 pildid/mook.png')
